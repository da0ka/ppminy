...
(a=>decoder={fn:"b",
64:a,
122:"for(b='++]Eu[nED=256=i;o--,eb=else{=c;)b[>>>0;e.b8||,tk=>{.e.lengthif(=0,=1l[e	=[]s++=b.lfor(e of a)){s=0;!	]]={b:0:r};b,b,c=bvar r,f,k<<|=kt+=7<(D=e-=8=k<<7-t&255)},i,sc=[,10,13,34,38,92],ano,l,u;f+k.charCodeAt(s++);b(f))f<12((i=f8&7)<7&&b(c[i]),f&27);kn;rr;,~u[0]0;a*);i=a<1e7*)f=(f<<8|D)ii=o/(s+i)f/ob<s&&b<())break;s-;k[tE=r=e;e;(+=2)8);e=a=)a;;a!;c)	E[cc?a:();e;)	];	].l}l}	];a=a}f-=o*s}return k}';G=/[-DE]/.exec(b);)with(b.split(G))b=join(shift());eval(b)",
253:a
