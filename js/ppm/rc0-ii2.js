...
(a=>decoder={fn:"b",
64:a,
122:"for(b='r/f/Klse{J++]Iu[sIH=iG--F,fEr=r>6D=t;)g[>>>0;=258||;e;nfor(;=n=ob=a=>{if(.o.f=1o of n)h[o=0;){l!]	=0,l+G+o=g.r=[],f+=]={o:vE:0.lengthgg,gt=gvar a<<,o|=af,7E<(HE-=8,o5&a<<7-f)},e,sc,o,rEi,ldk,t=[,10,13,34,38,92],hun,g,v6;g+a.charCodeAt(l++);b(g&127))Fg<12(i=g8&7)<7&&b(t[i])as;vFv};,~u[0]F0}*G	)k<1e7*6)b=(b<<8|H)i=kk=e/(l+i)g=b/eg<l	&&g<())break;l-G;a[dI=v;g.2;(o.2)8){c=fr,r&&n)n[cI=n=c||k}o=)nJk+!;t)f+t,rG*2*(6+f),k,D*f?2+K2:K1.6,t.D?6:r,I[t|r}t?n:();Fo;)g=];].r}h=[]}eJ]}b-=e*l}return a}';_=/[-D-K]/.exec(b);)with(b.split(_))b=join(shift());eval(b)",
