...
(a=>decoder={fn:"f",
64:a,
122:`for(f='++YY]Xu[oXWif(VVb)kUe/t/T=e>6S=256R;VQ=1PQbP<O.cNgNL=sK8|J,cI))H&&G>>>Fq/jF0E]={s:Dp[r%n[c$.s#$#]"<<4|h#],[b=g;jfK=>{|(=f=cfor(;.l--,t,e){c of g)=d=v	=0,+=}else{DbI:0=[t=0VengthddNd#	,v=dvar q,jP,acK[0d,sPI|KFt7<JW-=8IK7-t&255)},h,i,k,rov=[,10,13,34,38,92g	,nmpMub	NR;dP+sNharCodeAt(aY);f(dHd<12J(e=dF8&7)<7Gf(v[e]),d&P27);b;mD8*(bF4)+53I:7,l:3},M]=Matqrt(bHaP6,d	[b};a;)pa]=0b+114)/(b+2);,~u];)d	}soP;*i<1e7*R)q=(qJW)F0Oie=!")t1+cNY;f=iFJ|iOfGn)h=m[M[e-1]k3L>8*i)2i>2*e)1|g#+h>2*i-=Fh,f!f=j/(t+f)F0,r=EQc=r<t!"Gr<(tfP+cNHbreak;t-}c[0f=%NM[g#-1]]FP4P6384-fQE<ft%]eF6c%]-F6,f=e}}q-=j*tQcUh>6||hN|*=2,hN=3hY);s[aX=b#;d;L2Q(cN2)F8r=teNFPGg#)g[rX;L=tg=r||i}Vc=	g	iL;g!	;v	#)t	N+v*2*(6+t)iS*t?2+T2:T1.6,vNeS?6:e,$X	[v|e}v?g:();c;)d=$];$]	}n=[]UP,t+f"Ph=i;i=;)V!(g#Hreturn s}}}';_=/[^ !&-CM[-~]/.exec(f);)with(f.split(_))f=join(shift());eval(f)`,
